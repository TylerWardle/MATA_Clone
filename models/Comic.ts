...
export class Comic {
    ...
    insert(_title: String, _authorUsername: String, _publicationDate: Date, _description: String, _genre: String, _toPublish: Boolean, callback: Function): any {
    ...
    // UPDATE **WORKS**
    update(_comicID: String, _title: String, _authorUsername: String, _publicationDate: Date, _description: String, _genre: String, _toPublish: Boolean, callback: Function): void {
        var db = this.mongoose.connection;
        var comicModel = Comic.comic;
