...
export class Comic {
    ...
    insert(_authorID: String, _title: String, _publicationDate: String, _description: String, _genre: String, _toPublish: Boolean, callback: Function): any {
    ...
    // UPDATE
    update(_comicID: String, _authorID: String, _title: String, _publicationDate: String, _description: String, _genre: String, _toPublish: Boolean, callback: Function): void {
        var db = this.mongoose.connection;
        var comicModel = this.comic;
